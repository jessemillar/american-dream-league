...
CREATE TABLE Emails(emailID int NOT NULL, screenname varchar(500), domain varchar(500), PRIMARY KEY (emailID));
...
CREATE TABLE Passwords(passwordID int NOT NULL, hash binary(64), PRIMARY KEY (passwordID));
